    ...
    content: (
      <div style={{ fontSize: 16, lineHeight: 1.6 }}>
        ...
        <ul style={{ listStyle: 'none', padding: 0, marginBottom: 12 }}>
          ...
          <li>• На старте важно вывести в плюс юнит 1 уровня (AMPPU) и юнит 2 уровня (AMPU - CPUser).</li>
          <li>• Пока эти юниты в минусе — каждый новый пользователь приносит убыток.</li>
